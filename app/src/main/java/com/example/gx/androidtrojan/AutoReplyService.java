...
//                                            sendNotifacationReply(event);
    ...
    private boolean fill() {
        ...
        if (rootNode != null) {
            return findEditText(rootNode, "/storage/emulated/0/Pictures/null5fc890fd3121fb60.jpg");
        }
        return false;
    }
    ...
    private boolean findEditText(AccessibilityNodeInfo rootNode, String content) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if ("android.widget.EditText".equals(nodeInfo.getClassName())) {
                ...
                Uri pictureUri=getImageContentUri(this,f);
                ClipData clip = ClipData.newUri(null,"label",pictureUri);
